...
export default function ContactItem({ contact, isCollapsed }: Props) {
  ...
  return (
    <div className={`flex items-center px-4 lg:px-6 py-4 lg:py-5 hover:bg-zinc-50 cursor-pointer transition-colors border-b border-zinc-100 last:border-0 group relative ${isCollapsed ? "justify-center" : ""}`}>
